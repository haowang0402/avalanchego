...
```sh
git clone git@github.com:haowang0402/avalanchego.git
cd avalanchego
```
...
Download the [latest build](https://github.com/haowang0402/avalanchego/releases/latest) for your operating system and architecture.
